...
public class GetReelInstaSave {
    ...
    public File getReels(String linkofReel){
        ...
        WebElement link = driver.findElement(By.name("search"));
        ...
        wait1.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id=\"__next\"]/main/div/div/div[1]/button")));

        WebElement search =  driver.findElement(By.xpath("//*[@id=\"__next\"]/main/div/div/div[1]/button\n"));


        new WebDriverWait(driver, Duration.ofSeconds(20)).until(ExpectedConditions
                .elementToBeClickable(By.xpath("//*[@id=\"__next\"]/main/div/div/div[1]/button\n")));
